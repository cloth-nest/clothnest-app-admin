...
class AddProductAttributeDialog extends StatefulWidget {
  ...
  @override
  State<AddProductAttributeDialog> createState() =>
      _AddProductAttributeDialogState();
}

class _AddProductAttributeDialogState extends State<AddProductAttributeDialog> {
  bool isActive = false;
  @override
    ...
    return AlertDialog(
      ...
      title: Container(
        ...
        child: Column(
          ...
          children: [
            Text('Create new attribute', style: AppStyles.medium),
