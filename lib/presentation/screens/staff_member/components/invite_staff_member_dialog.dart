...
class InviteStaffMemberDialog extends StatefulWidget {
  const InviteStaffMemberDialog({super.key});

  @override
  State<InviteStaffMemberDialog> createState() =>
      _InviteStaffMemberDialogState();
}

class _InviteStaffMemberDialogState extends State<InviteStaffMemberDialog> {
  bool isActive = false;
